...
class TicketCommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ticket_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'ticket_comments_ibfk_1' => ['type' => 'foreign', 'columns' => ['ticket_status_id'], 'references' => ['ticket_status', 'id'], 'update' => 'setNull', 'delete' => 'setNull', 'length' => []],
