...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'start_date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => '0000-00-00 00:00:00', 'comment' => '', 'precision' => null],
        'end_date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => '0000-00-00 00:00:00', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'fk_events_users' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'start_date' => '2016-02-22 19:40:03',
            'end_date' => '2016-02-22 19:40:03',
