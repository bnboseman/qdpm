...
class UsersGroupsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'allow_manage_tasks_viewonly' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'allow_manage_discussions' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'allow_manage_discussions_viewonly' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'allow_manage_tasks_viewonly' => 1,
            'allow_manage_discussions' => 1,
            'allow_manage_discussions_viewonly' => 1
        ],
    ];
}
