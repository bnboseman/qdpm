...
class DiscussionCommentsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('DiscussionComments') ? [] : ['className' => 'App\Model\Table\DiscussionCommentsTable'];
        $this->DiscussionComments = TableRegistry::get('DiscussionComments', $config);
    }
