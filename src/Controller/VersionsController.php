...
class VersionsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Projects', 'VersionsStatus']
        ];
    ...
    public function add()
    {
        ...
        $projects = $this->Versions->Projects->find('list', ['limit' => 200]);
        $versionsStatus = $this->Versions->VersionsStatus->find('list', ['limit' => 200]);
        $this->set(compact('version', 'projects', 'versionsStatus'));
        $this->set('_serialize', ['version']);
    }
